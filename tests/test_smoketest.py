...
class TestSmokeTest():
  ...
  def test_test1LogoHeaderandTitle(self):
    ...
    self.driver.set_window_size(1002, 816)
  ...
  def test_test2HomePageSpotlightsandJoinFeature(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1056, 816)
    ...
    self.vars["startUrl"] = self.driver.execute_script("return window.location.href;")
  ...
  def test_test3DirectoryGridandListfeature(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, "section:nth-child(1) > p:nth-child(2)").text == "Teton Elementary"
    assert self.driver.find_element(By.CSS_SELECTOR, "section:nth-child(1) > p:nth-child(3)").text == "126 Main Street"
    assert self.driver.find_element(By.CSS_SELECTOR, "section:nth-child(1) > p:nth-child(4)").text == "Teton, ID 83451"
    elements = self.driver.find_elements(By.LINK_TEXT, "Website")
    assert len(elements) > 0
  ...
  def test_test4JoinPageDataEntry(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Nelson")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Georges")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Nelka Services")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Chief Executive Officer")
